...
// 验证函数
export function validateFeishuConfig(config: unknown): {
  success: boolean
  data?: FeishuConfig
  errors: string[]
} {
...
export function validateTableDataConfig(config: unknown): {
  success: boolean
...
// 验证字段映射
export function validateFieldMapping(mapping: any): {
  success: boolean
  data?: FieldMapping
  errors: string[]
} {
